    ...
    <div className="w-full max-w-md">
      ...
      <form action="dashboard.html" method="POST" className="bg-white shadow-md rounded px-8 py-6">
        ...
        <div className="flex items-center justify-between">
          <Link to="/dashboard/student"> <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button">
            Sign In
          </button></Link>
